...
('Onboarding 10%', 10,  'perfil',  'perfil_completo',     1),
('Onboarding 50%', 50,  'perfil',  'perfil_completo',     1),
('Onboarding 100%',100, 'perfil',  'perfil_completo',     1),
('Primer Proyecto',20,  'proyecto','proyectos',           1),
('5 Proyectos',    60,  'proyecto','proyectos',           5),
('10 Proyectos',   120, 'proyecto','proyectos',           10),
('Primer Cert',    15,  'cert',    'certificados',        1),
('3 Certs',        45,  'cert',    'certificados',        3),
...
((SELECT id_app_user FROM app_user ORDER BY name LIMIT 1 OFFSET 0),
 (SELECT badge_id FROM badge ORDER BY badge_name LIMIT 1 OFFSET 0),  1, NOW() - INTERVAL '10 days'),
((SELECT id_app_user FROM app_user ORDER BY name LIMIT 1 OFFSET 1),
 (SELECT badge_id FROM badge ORDER BY badge_name LIMIT 1 OFFSET 3),  1, NOW() - INTERVAL '9 days'),
((SELECT id_app_user FROM app_user ORDER BY name LIMIT 1 OFFSET 2),
 (SELECT badge_id FROM badge ORDER BY badge_name LIMIT 1 OFFSET 6),  1, NOW() - INTERVAL '8 days'),
((SELECT id_app_user FROM app_user ORDER BY name LIMIT 1 OFFSET 3),
 (SELECT badge_id FROM badge ORDER BY badge_name LIMIT 1 OFFSET 1),  1, NOW() - INTERVAL '7 days'),
((SELECT id_app_user FROM app_user ORDER BY name LIMIT 1 OFFSET 4),
 (SELECT badge_id FROM badge ORDER BY badge_name LIMIT 1 OFFSET 4),  3, NOW() - INTERVAL '6 days'),
((SELECT id_app_user FROM app_user ORDER BY name LIMIT 1 OFFSET 5),
 (SELECT badge_id FROM badge ORDER BY badge_name LIMIT 1 OFFSET 5),  7, NOW() - INTERVAL '5 days'),
((SELECT id_app_user FROM app_user ORDER BY name LIMIT 1 OFFSET 6),
 (SELECT badge_id FROM badge ORDER BY badge_name LIMIT 1 OFFSET 2),  1, NOW() - INTERVAL '4 days'),
((SELECT id_app_user FROM app_user ORDER BY name LIMIT 1 OFFSET 7),
 (SELECT badge_id FROM badge ORDER BY badge_name LIMIT 1 OFFSET 7),  2, NOW() - INTERVAL '3 days'),
((SELECT id_app_user FROM app_user ORDER BY name LIMIT 1 OFFSET 8),
 (SELECT badge_id FROM badge ORDER BY badge_name LIMIT 1 OFFSET 8),  1, NOW() - INTERVAL '2 days'),
((SELECT id_app_user FROM app_user ORDER BY name LIMIT 1 OFFSET 9),
 (SELECT badge_id FROM badge ORDER BY badge_name LIMIT 1 OFFSET 9), 10, NOW() - INTERVAL '1 days');
