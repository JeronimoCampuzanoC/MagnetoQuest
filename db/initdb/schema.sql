...
CREATE TYPE mission_category AS ENUM ('Trivia', 'Certificate', 'Project', 'CV', 'Application', 'Trivia_Special', 'Trivia_Abilities', 'Trivia_Interview', 'Trivia_Employment');

CREATE TYPE mission_frequency AS ENUM ('daily', 'flash', 'weekly', 'monthly');
...
CREATE TABLE mission (
    ...
    frequency mission_frequency NOT NULL DEFAULT 'daily',
...
CREATE TABLE trivia_attempt (
    ...
    total_time FLOAT NOT NULL CHECK (total_time >= 0),
    precision_score FLOAT NOT NULL CHECK (precision_score >= 0),
...
VALUES
    -- Misiones Diarias - Trivia
    (
        'Trivia Diaria',
        'Completa una trivia diaria para mantener tu racha activa',
        'Trivia',
        'daily',
        30,
        1,
    ...
    (
        'Práctica con Trivias',
        'Responde 2 trivias en un día',
        'Trivia',
        'daily',
        50,
        2,
...
(
    'Aplicación Express',
    'Te están buscando y aún no lo sabes, aplica a JR RPA DEVELOPER ENGLISH C1 en Solvo',
    'Application',
    'flash',
    100,
    1,
...
(
    'Sprint de Aplicaciones',
    'Esta empresa vio tu perfil y dijo: Queremos a alguien así. No dejes que otro se siente en esa silla. Mira la vacante antes de que cierre Ingeniero Especialista Azure Devops SYNERGY TECHNOLOGY AND PROCESS CONSULTING S A S $5,800,000',
    'Application',
    'flash',
    100,
    1,
...
(
    'Trivia de Habilidades',
    'Completa una trivia sobre habilidades blandas',
    'Trivia_Abilities',
    'weekly',
    75,
    1,
...
(
    'Trivia de Entrevistas',
    'Practica preguntas de entrevistas con trivia',
    'Trivia_Interview',
    'weekly',
    75,
    1,
...
(
    'Trivia de Empleo',
    'Resuelve una trivia sobre el mundo laboral',
    'Trivia_Employment',
    'weekly',
    75,
    1,
...
-- Misiones Mensuales - Desarrollo Profesional
(
    'Certificado del Mes',
    'Agrega un nuevo certificado a tu perfil',
    'Certificate',
    'monthly',
    150,
    1,
...
(
    'Proyecto Destacado',
    'Publica un proyecto en tu portafolio',
    'Project',
    'monthly',
    150,
    1,
...
(
    'Actualiza tu CV',
    'Mejora tu hoja de vida con nueva información',
    'CV',
    'monthly',
    150,
    1,
