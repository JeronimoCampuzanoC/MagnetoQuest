    ...
    >
      ...
      {steps.map((s, i) => {
        ...
        return (
          <div
            key={i}
            className={`${styles.step} ${unlocked ? styles.unlocked : styles.locked}`}
            style={{ left, width: height, height, marginLeft: -(height / 2) }}
            aria-label={unlocked ? `Hito ${s}% completado` : `Hito ${s}% bloqueado`}
          >
